    ...
    return (
        <div className="min-h-screen flex items-center justify-center text-slate-800 dark:text-white relative overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors">
            ...
            <motion.div
                ...
                className="w-full max-w-md bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-white/50 dark:border-slate-800 p-8 rounded-3xl shadow-xl ring-1 ring-slate-900/5 dark:ring-white/5 transition-colors"
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 mt-2 transition-colors">Sign in to continue to Smart AI</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1.5">
                            <label className="block text-slate-600 dark:text-slate-400 text-sm font-medium transition-colors">Password</label>
                            <Link to="/forgot-password" title="Check your email for instructions" className="text-primary dark:text-indigo-400 text-xs font-medium hover:underline">Forgot?</Link>
                        </div>
                        <input
                            type="password"
                            required
                    ...
                    <button
                        disabled={loading}
                        className="w-full bg-gradient-to-r from-primary to-secondary py-3.5 rounded-xl font-bold text-white hover:opacity-90 hover:shadow-lg hover:shadow-indigo-500/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed transform active:scale-[0.98]"
                    >
                ...
                <div className="mt-8 text-center text-slate-500 dark:text-slate-400 text-sm transition-colors">
                    Don't have an account? <Link to="/signup" className="text-primary dark:text-indigo-400 font-bold hover:underline">Sign Up</Link>
                </div>
            </motion.div>
        </div>
    );
